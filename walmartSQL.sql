...
SELECT DISTINCT customer_type AS unique_type
FROM sales;

-- How many unique payment methods does the data have ? --------

SELECT DISTINCT payment_method AS unique_method
FROM sales;
...
-- What coustomer type buys the most ? -------------------------
...
GROUP BY gender
ORDER BY gender_cnt;
-- Gender per branch is almost the same
-- meaning there is no effect os sales per branch or other factor
...
SELECT branch, time_of_day, AVG(rating) AS rating_count
FROM sales
WHERE branch = "A"
GROUP BY time_of_day
ORDER BY rating_count DESC;
